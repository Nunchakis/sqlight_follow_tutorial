...
const uint32_t ID_SIZE = sizeof(uint32_t); //size_of_attribute(Row, id);
const uint32_t USERNAME_SIZE = COLUMN_USERNAME_SIZE; //size_of_attribute(Row, username);
const uint32_t EMAIL_SIZE = COLUMN_EMAIL_SIZE; //size_of_attribute(Row, email);
